...
public class LightSliderUI extends BasicSliderUI {
	...
	public LightSliderUI(JSlider b, Color color) {
		super(b);
		rangeColor = color;
	}

	public static ComponentUI createUI(JComponent c) {
		return new LightSliderUI((JSlider) c, Color.BLUE);
	}
	...
	/**
	 * Returns the size of a thumb. Parent method not use size from LaF
	 * 
	...
	public void paintTrack(Graphics g) {
		...
		if (slider.getOrientation() == SwingConstants.HORIZONTAL) {
			g2d.drawLine(
					trackRect.x, trackRect.y + trackRect.height / 2, trackRect.x + trackRect.width,
	...
	/**
	 * Listener to handle model change events. This calculates the thumb locations and repaints the slider if the value change is
	 * not caused by dragging a thumb.
	 */
	...
	public static void main(String[] args) {
		...
		slider.setUI(new LightSliderUI(slider, Color.BLUE));
		frame.add(slider);
